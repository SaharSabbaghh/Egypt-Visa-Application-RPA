...
class EgyptVisaFormAutomation:
    ...
    def setup_driver(self):
        ...
        common_paths = [
            project_root / 'bin' / 'chromedriver',  # Project bin directory
        ...
        if not driver_found:
            raise Exception(
                ...
                "  3. Extract and place in: " + str(project_root / 'bin' / 'chromedriver') + "\n"
                "  4. Run: chmod +x " + str(project_root / 'bin' / 'chromedriver') + "\n\n"
